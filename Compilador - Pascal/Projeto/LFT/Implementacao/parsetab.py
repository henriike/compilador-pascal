...
_lr_action_items = {'PROGRAM':([0,],[2,]),'$end':([1,4,5,6,8,10,12,13,14,17,21,22,38,42,43,47,48,51,55,56,],[0,-2,-1,-9,-22,-4,-3,-22,-22,-8,-20,-21,-7,-11,-6,-10,-24,-23,-26,-25,]),'ID':([2,7,9,15,16,20,25,26,34,35,38,42,45,50,52,],[3,11,19,23,24,27,27,19,19,19,11,19,27,27,19,]),'SEMICOLON':([3,27,28,29,30,31,32,33,36,44,49,53,],[4,-17,38,-12,-13,-14,-15,-16,42,48,52,55,]),'CONST':([4,],[7,]),'VAR':([4,6,10,38,43,],[-5,9,-4,-7,-6,]),'PROCEDURE':([4,6,8,10,13,14,17,38,42,43,47,48,51,55,56,],[-5,-9,15,-4,15,15,-8,-7,-11,-6,-10,15,-23,-26,-25,]),'FUNCTION':([4,6,8,10,13,14,17,38,42,43,47,48,51,55,56,],[-5,-9,16,-4,16,16,-8,-7,-11,-6,-10,-24,-23,16,-25,]),'EQUALS':([11,],[20,]),'TWOPOINTS':([18,19,37,40,46,],[25,-18,-19,45,50,]),'COMMA':([19,],[26,]),'INTEGER':([20,25,45,50,],[29,29,29,29,]),'REAL':([20,25,45,50,],[30,30,30,30,]),'STRING':([20,25,45,50,],[31,31,31,31,]),'BOOLEAN':([20,25,45,50,],[32,32,32,32,]),'CHAR':([20,25,45,50,],[33,33,33,33,]),'LPARENT':([23,24,],[34,35,]),'RPARENT':([34,35,39,41,52,54,],[-28,-28,44,46,-28,-27,]),}
...
_lr_goto_items = {'program':([0,],[1,]),'block':([4,],[5,]),'const_declaration_part':([4,],[6,]),'var_declaration_part':([6,],[8,]),'const_definition':([7,38,],[10,43,]),'subroutine_declaration_part':([8,13,14,],[12,21,22,]),'procedure_declaration':([8,13,14,48,],[13,13,13,51,]),'function_declaration':([8,13,14,55,],[14,14,14,56,]),'var_declaration':([9,42,],[17,47,]),'identifier_list':([9,26,34,35,42,52,],[18,37,40,40,18,40,]),'types':([20,25,45,50,],[28,36,49,53,]),'param_section':([34,35,52,],[39,41,54,]),}
