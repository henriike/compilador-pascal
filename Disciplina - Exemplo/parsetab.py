...
_lr_productions = [
  ...
  ('program -> funcdecl','program',1,'p_program','ExpressionLanguageParser.py',23),
  ('program -> funcdecl program','program',2,'p_program','ExpressionLanguageParser.py',24),
  ('funcdecl -> signature body','funcdecl',2,'p_funcdecl','ExpressionLanguageParser.py',32),
  ('signature -> ID ID LPAREN sigparams RPAREN','signature',5,'p_signature','ExpressionLanguageParser.py',36),
  ('signature -> ID ID LPAREN RPAREN','signature',4,'p_signature','ExpressionLanguageParser.py',37),
  ('sigparams -> ID ID','sigparams',2,'p_sigparams','ExpressionLanguageParser.py',44),
  ('sigparams -> ID ID COMMA sigparams','sigparams',4,'p_sigparams','ExpressionLanguageParser.py',45),
  ('body -> LCHAV stms RCHAV','body',3,'p_body','ExpressionLanguageParser.py',53),
  ('body -> LCHAV RCHAV','body',2,'p_body','ExpressionLanguageParser.py',54),
  ('stms -> stm','stms',1,'p_stms','ExpressionLanguageParser.py',61),
  ('stms -> stm stms','stms',2,'p_stms','ExpressionLanguageParser.py',62),
  ('stm -> exp PV','stm',2,'p_stm','ExpressionLanguageParser.py',69),
  ('stm -> WHILE LPAREN exp RPAREN body','stm',5,'p_stm','ExpressionLanguageParser.py',70),
  ('stm -> RETURN exp PV','stm',3,'p_stm','ExpressionLanguageParser.py',71),
  ('exp -> exp IGUAL exp1','exp',3,'p_exp_assign','ExpressionLanguageParser.py',82),
  ('exp -> exp1','exp',1,'p_exp_assign','ExpressionLanguageParser.py',83),
  ('exp1 -> exp1 SOMA exp2','exp1',3,'p_exp1_soma','ExpressionLanguageParser.py',91),
  ('exp1 -> exp2','exp1',1,'p_exp1_soma','ExpressionLanguageParser.py',92),
  ('exp2 -> exp2 VEZES exp3','exp2',3,'p_exp2_vezes','ExpressionLanguageParser.py',100),
  ('exp2 -> exp3','exp2',1,'p_exp2_vezes','ExpressionLanguageParser.py',101),
  ('exp3 -> exp4 POT exp3','exp3',3,'p_exp3_pot','ExpressionLanguageParser.py',109),
  ('exp3 -> exp4','exp3',1,'p_exp3_pot','ExpressionLanguageParser.py',110),
  ('exp4 -> call','exp4',1,'p_exp4_call','ExpressionLanguageParser.py',117),
  ('exp4 -> NUMBER','exp4',1,'p_exp4_call','ExpressionLanguageParser.py',118),
  ('exp4 -> ID','exp4',1,'p_exp4_call','ExpressionLanguageParser.py',119),
  ('exp4 -> TRUE','exp4',1,'p_exp4_call','ExpressionLanguageParser.py',120),
  ('exp4 -> FALSE','exp4',1,'p_exp4_call','ExpressionLanguageParser.py',121),
  ('call -> ID LPAREN params RPAREN','call',4,'p_call_id_params','ExpressionLanguageParser.py',133),
  ('call -> ID LPAREN RPAREN','call',3,'p_call_id_params','ExpressionLanguageParser.py',134),
  ('params -> exp COMMA params','params',3,'p_params_ids','ExpressionLanguageParser.py',142),
  ('params -> exp','params',1,'p_params_ids','ExpressionLanguageParser.py',143),
]
